                ...
                <div class="collapse navbar-collapse" id="nvbCollapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active pl-1">
                            <a class="nav-link" href="showRegisterForm"><i class="fa fa-th-list fa-fw mr-1"></i>Register</a>
                        </li>
                        <li class="nav-item pl-1">
                            <a class="nav-link" href="about.html"><i class="fa fa-user-plus fa-fw mr-1"></i>About</a>
                        </li>
                        <li class="nav-item pl-1">
                            <a class="nav-link" href="showLoginForm"><i class="fa fa-sign-in fa-fw mr-1"></i>Login</a>
                        </li>
                    </ul>
                </div>
            </div>
