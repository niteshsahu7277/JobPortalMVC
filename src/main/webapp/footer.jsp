<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <footer class="fixed-bottom">
        <div class="footer jumbotron jumbotron-fluid bg-secondary p-4 mt-5 mb-0">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 cizgi">
                        <div class="card bg-secondary border-0">
                            <div class="card-body text-light text-center">
                                <h5 class="card-title text-white display-4" style="font-size:20px">Copyright</h5>
                                <p class="d-inline text-white lead">JobBazar © 2020<br>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 cizgi">
                        <div class="card bg-secondary border-0">
                            <div class="card-body text-center">
                                <h5 class="card-title text-white display-4" style="font-size:20px">Contact</h5>
                                ...
                                <a class="text-light d-block lead" href="#"><i
                                        class="fa fa-envelope mr-2"></i>support@JobBazar.com</a>
                            </div>
                        </div>
                    </div>
